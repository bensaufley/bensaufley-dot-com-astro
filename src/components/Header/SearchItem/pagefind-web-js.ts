...
// https://github.com/Pagefind/pagefind/blob/main/pagefind_web_js/types/index.d.ts
...
export interface PagefindTermParams {
...
export interface PagefindTermScore {
  /** Term */
  search_term: string;
...
export interface PagefindTermScoreParams {
...
export interface PagefindVerboseWordLocation {
  /**
...
declare function options(options: PagefindIndexOptions): Promise<void>;
declare function search(term: string, options?: PagefindSearchOptions): Promise<PagefindIndexesSearchResults>;
declare function debouncedSearch(
  term: string,
  options?: PagefindSearchOptions,
  debounceTimeoutMs?: number,
): Promise<PagefindIndexesSearchResults | null>;

declare function preload(term: string, options?: PagefindSearchOptions): Promise<void>;
declare function filters(): Promise<PagefindFilterCounts>;
declare function destroy(): Promise<void>;

export { debouncedSearch, destroy, filters, options, preload, search };

// https://github.com/Pagefind/pagefind/blob/main/pagefind_web_js/lib/highlight.ts
...
declare class PagefindHighlight {
  public highlightParam: string;

  public markContext: string | HTMLElement | HTMLElement[] | NodeList | null;

  public markOptions: Mark.MarkOptions;

  public addStyles: boolean;

  constructor(options?: pagefindHighlightOptions);

  public getHighlightParams(paramName: string): string[];

  public addHighlightStyles(className: string): void;

  public createMarkInstance(): Mark;

  public markText(instance: Mark, text: string[]): void;

  public highlight(): void;
}

export { PagefindHighlight };
